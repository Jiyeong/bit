...
public class HelpServlet extends GenericServlet {
  ...
  public void service(ServletRequest request, ServletResponse response)
    ...
    out.println("<html>");
    out.println("<body>");
    out.println("<h1> < Manual > </h1><br><hr>");
    ...
    out.println("<p> 리스트에서 m개 항목씩 묶음의 n번째 page 보기 : "
        + "     /product/list?pageNo=no&pageSize=m</p><br>");
    
    out.println("<h2>view 제품번호</h2>");
    out.println("<p> 선택한 번호(no)에 해당하는 상세 정보 보기 : "
        + "     /product/view?no=n</p><br>");
    
    out.println("<h2>add</h2>");
    out.println("<p> 제품의 이름, 수량, 제조사번호를 작성하여 리스트에 추가하기 : <br>"
        + "     /product/add?name=이름&qty=수량&mkno=제조사번호</p><br>");
    
    out.println("<h2>delete 제품번호</h2>");
    out.println("<p> 선택한 번호(no)에 해당하는 정보 삭제하기 : "
        + "     /product/delete?no=n</p><br>");
    
    out.println("<h2>update 제품번호</h2>");
    out.println("<p> 리스트 내에서 선택한 번호의 "
        + "정보(이름, 수량, 제조사번호)를 수정한다. : <br>"
        + "     /product/update?no=번호&name=이름&qty=수량&mkno=제조사번호</p><br>");

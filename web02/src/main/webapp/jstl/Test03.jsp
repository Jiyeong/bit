...
<h2>c:choose</h2><!-- switch case문 흉내낼 수 있다!!!! -->
...
<h2>c:forTokens</h2><!-- split처럼 문자열 잘라줌!! -->
<%
pageContext.setAttribute("params","names=aaa&age=20&tel=111-1111");
%>

...
public class Test40 {
  ...
  public static void main(String[] args) {
    ...
    /*
  1) 인스턴스 변수 준비
      [maker][model][cc ][die..][rele...][cap..][weight][autoDump]

  2) 인스턴스 변수를 0으로 초기화
      [0    ][0    ][0  ][0    ][null(0)][0    ][0.0   ][false(0)]

  3) Car 클래스의 초기화 문장 수행
      [0    ][0    ][800][0    ][null(0)][5    ][0.0   ][false   ] // super

     Truck 클래스의 초기화 문장 수행
      [0    ][0    ][800][0    ][null(0)][5    ][1000.0][false   ] // sub

...
public class MyKey {
  ...
  public String toString() {
    return "MyKey [password=" + password + ", specialNo=" + specialNo
        + ", secresteNo=" + secreteNo + "]";
  }
  
  // password, specialNo, screteNo 값이 같을 때는

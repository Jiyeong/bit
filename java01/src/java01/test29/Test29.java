/*
캡슐화(encapsulation)?
 - 클래스를 정의한 의도와 다르게 사용할 경우 변수나 메서드를 사용할 경우
   오류가 발생하게 된다.
   1) 변수에 무효한 값을 넣는다거나,
 ...
 - => 클래스 작성자가 의도한 대로만 사용하도록 접근을 제한하는 문법.
   => 최소한의 안전장치!
 - 문법 : 
   [접근제어자(access modifier)] 타입 변수명;
   [접근제어자(access modifier)] 리턴타입 메서드(함수)명(...){...}
 - 접근제어자 : 
...
public class Test29 {
  public static void main(String[] args){
    ...
    // 따라서 다음과 같이 별도로 초기화할 필요는 없다.
    // Calculator.result = 0;
    
    Calculator.plus(10);
    Calculator.plus(2);
    Calculator.multiple(7);
    //Calculator.result = -100 // 히히 메롱 <=접근불가
    Calculator.minus(4);
    Calculator.divide(2);

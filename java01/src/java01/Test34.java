...
public class Test34 {
  ...
  public static void main(String[] args) {
    ...
    /*
     l-value, r-value
     - 할당 연산자를 기준으로 왼쪽 메모리를 l-value라 한다.
     - 할당 연산자를 기준으로 오른 쪽의 상수 값이나 변수를 r-value라 한다.
    ...
    */
    ...
    byte b3 = (byte)i;
    // i는 10이란 값이기 때문에 1바이트로 만들어 b3에 넣더라도 문제 없다.
    ...
    System.out.print(b4); 
    // 앞의 3바이트 날아감. 슝. 잘림!
    // -128 ; 1000 0000 바이트에서는 맨 앞자리가 양수/음수 check
    // 0 ; 0000 0000 

...
public class Test13 {
  ...
  public static void main(String[] args) {
    ...
    int[] scores = new int[5]; /// C랑 다름.new가 있어야 한다.
    // 신규 배열 5개의 생성 및 주소 할당
    //scores =new byte[6]; /// 엄격해, 안됨.
    scores = new int[3]; /// 언제든지 대체할 수 있음
    // 신규 배열 3개 생성 및 주소 할당
    ...
    System.out.println("--------------------");
    scores = new int[]{100, 90, 100}; // new 반드시 주어야 함
